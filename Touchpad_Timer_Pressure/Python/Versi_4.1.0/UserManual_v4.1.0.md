...
16. [Tab Analisa multifile](#16-tab-analisa-multifile)
17. [Nilai Default Pabrik](#17-nilai-default-pabrik)
18. [Penjelasan Teknis Detektor](#18-penjelasan-teknis-detektor)
...
Tekan **🗑 Clear All** untuk menghapus semua data yang dimuat di tab **Analisa Data** dan mereset seluruh plot (log + tabel + split time).

---

## 16. Tab Analisa multifile
