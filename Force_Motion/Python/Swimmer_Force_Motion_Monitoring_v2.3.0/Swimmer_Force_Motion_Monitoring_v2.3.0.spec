...
# PyInstaller spec — Swimmer Force Motion Monitoring v2.3.0 (onefile, Windows)
...
a = Analysis(
    ["Swimmer_Force_Motion_Monitoring_v2.3.0.py"],
    pathex=[],
    binaries=pyside6_binaries + cv2_binaries,
    datas=[
        ("UserManual_Force_Motion_v2.3.0-e.pdf", "."),
...
exe = EXE(
    ...
    a.datas,
    [],
    name="Swimmer_Force_Motion_Monitoring_v2.3.0",
    debug=False,
