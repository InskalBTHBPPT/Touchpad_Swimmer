...
Versi modul ini: **2.2.0** (nama berkas ``Swimmer_Force_Motion_Monitoring_v2.2.0.py``).
...
APP_VERSION = "2.2.0"
USER_MANUAL_MD = SCRIPT_DIR / "UserManual_Force_Motion_v2.2.0.md"
USER_MANUAL_PDF = SCRIPT_DIR / "UserManual_Force_Motion_v2.2.0.pdf"
    ...
    def open_user_manual_pdf(self) -> None:
        ...
        if not pdf.is_file():
            self._show_statistik_message_box(
                ...
                f"-i Swimmer_Force_Motion_Monitoring_v2.2.0/{USER_MANUAL_MD.name} "
                f"-o Swimmer_Force_Motion_Monitoring_v2.2.0/{USER_MANUAL_PDF.name}\n\n"
