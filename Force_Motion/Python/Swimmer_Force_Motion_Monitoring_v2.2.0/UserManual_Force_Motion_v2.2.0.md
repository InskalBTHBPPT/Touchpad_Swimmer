...
Jalankan aplikasi dari folder `Swimmer_Force_Motion_Monitoring_v2.2.0` (atau dengan path penuh):

```text
python Swimmer_Force_Motion_Monitoring_v2.2.0.py
```
...
| `UserManual_Force_Motion_v2.2.0.md` | Manual ini (Markdown) |
| `UserManual_Force_Motion_v2.2.0.pdf` | Manual ini (PDF, opsional) |
...
python md_to_pdf_Force_Motion.py -i Swimmer_Force_Motion_Monitoring_v2.2.0/UserManual_Force_Motion_v2.2.0.md -o Swimmer_Force_Motion_Monitoring_v2.2.0/UserManual_Force_Motion_v2.2.0.pdf
```

Tanpa opsi, skrip bawaan masih mengarah ke manual **v1.0.0** di folder yang sama; untuk v2.2.0 gunakan `-i` dan `-o` seperti di atas.
